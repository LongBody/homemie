...
public class carRentController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet carRentController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet carRentController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dateCheckIn.equalsIgnoreCase("") || dateCheckOut.equals("")) {
            ...
            request.getRequestDispatcher("carRent.jsp").forward(request, response);
        } else {
            ...
            if (noOfDaysBetweenNow < 0 || noOfDaysBetween < 0) {
                ...
                int sum = (int) (1399999 * noOfDaysBetween);
