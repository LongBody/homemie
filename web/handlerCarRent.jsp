            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <a  class="btn" type="submit" href="paymentCarRentController?email=<%=email%>&quantity=${dayBetween}&dobBefore=${checkin}&dobAfter=${checkout}" style="background-color: #f65e38; color: white; margin-top: 20px;">Đặt Xe
                        </a>
                    ...
                    <div class="col-lg-4" style="background-color: #fff; border-radius: 10px; padding:30px 20px 50px 20px; height:100%;margin-top: 20px">
                        <div style="display: flex;width: 100%;">
                            <div style="display: inline-block;width: 50%;">
                                <span style="font-weight: bold; font-family: sans-serif; font-size: 15px">Vinfast Lux A2.0 (4 chỗ)</span>
                            </div>
                            <div style="margin-left: 50px;width: 50%; justify-content: flex-end;">
                                <img src="https://car-api-upload.luxstay.com/upload/file/1594883594-E2OXPnbvfWgz9J47w0q-PD6z.jpg" style="height: 100px;" />
                            </div>
                        </div>
                        <hr/>
                        <div>
                            <div>
                                <i class="fas fa-calendar-alt" style="color: #f65e38;margin-right: 3px;"></i> ${dayBetween} ngày  <span style="color: #f65e38;">* </span>  ${checkin} - ${checkout}
                            </div>
                        </div>
                        <hr/>
                        <div>
                        ...
                        <div>
                            <div>
                                <span style="font-weight: bold; font-family: sans-serif; font-size: 14px;">Chính Sách : </span> <span> Sau khi đặt chỗ xong, chúng tôi sẽ liên hệ lại để xác nhận với bạn.Vui lòng đặt xe trước ít nhất 02 tiếng so với giờ nhận xe.</span>
                                <p style="font-weight: bold; font-family: sans-serif; font-size: 14px;margin-top: 10px">Nếu có nhu cầu đặt chỗ ngay, vui lòng gọi hotline: 0344 914 287</p>
                            </div>
                        </div>
                    </div>
                </div>
